...
//Set gmail password
    ...
    // 	$email = 'vkchahar94@gmail.com';
        ...
        $email_message .= "Email ID: ".$email."\n <br>";
         ...
         $email_message .= "BTE Fitness Membership Training: ".$btefitness."\n <br>";
         $email_message .= "ETHOS Seminar: ".$ethos."\n <br>";
         $email_message .= "Online “DOSE” subscription: ".$dose."\n <br>";
         $email_message .= "Mental Health counseling: ".$mental."\n <br>";
         $email_message .= "Other: ".$other."\n <br>";
         $email_message .= "Meassage: ".$meassage."\n <br>";

	
        //Email subject
        	$mail->Subject = "Fit Club Contact";
        //Set sender email
